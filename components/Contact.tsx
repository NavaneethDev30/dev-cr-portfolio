...
const Contact = () => {
    return (
        <div className="w-full pb-20">
            <div id="contact" className='flex items-center justify-center w-full bg-white/5 backdrop-blur-sm border-y border-white/10 py-12 mb-16 mt-20 relative z-20 will-change-transform [transform:translateZ(0)]'>
                <h2 className="text-6xl font-semibold text-white tracking-wide">Contact</h2>
            </div>
            <div className='max-w-6xl mx-auto px-8 grid md:grid-cols-2 gap-12'>
                <div className="flex flex-col justify-center">
                    ...
                    <p className="text-zinc-400 mb-10 text-lg">I&apos;m currently looking for video editing and 3D animation opportunities.</p>
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex items-center gap-6 border-b border-white/10 pb-6 group">
                            <div className="flex-shrink-0 w-14 h-14 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center group-hover:bg-cyan-500/20 group-hover:border-cyan-500/50 transition-all duration-300">
                                <FaYoutube className="w-6 h-6 text-zinc-400 group-hover:text-cyan-400 transition-colors duration-300" />
                            </div>
                            <div>
                                <p className="text-zinc-500 text-sm font-semibold uppercase tracking-wider mb-1">YouTube</p>
                                <a href="https://www.youtube.com/@NavaneethDev" target="_blank" rel="noopener noreferrer" className="text-white text-lg font-medium hover:text-cyan-400 transition-colors duration-300">youtube.com/@NavaneethDev</a>
                            </div>
                        </div>
